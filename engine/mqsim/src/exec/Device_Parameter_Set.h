...
public:
	...
	// Not an upstream MQSim parameter (this project): when true, a read of a
	// never-written LPA completes without touching flash instead of making
	// the FTL reserve a page for it - see Address_Mapping_Unit_Page_Level::
	// translate_lpa_to_ppa(). Default false keeps upstream behavior (and the
